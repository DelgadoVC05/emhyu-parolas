        ...
        <div class="container">
          <div class="row gy-4 justify-content-center justify-content-lg-between">
            <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center mb-5">
              <h2 class="fade-in" style="display: block !important; opacity: 1 !important; visibility: visible !important;">Why Choose Parolas?</h2>
              <p class="fade-in"> Your Guimaras island adventure is not complete without taking home Parolas Guimaras. 
               ...
               <div class="d-flex heroBtn gap-3 align-items-center">
                <!-- Filled Button -->
                <button onclick="window.location.href='<?php echo home_url( '/product' ); ?>'" 
                        class="btn btn-get-started d-flex align-items-center">
                    <i class="fas fa-shopping-bag me-2"></i> 
                    <span>Explore Products</span>
                </button>                

                <!-- Outlined Button -->
                <button class="btn btn-video-play d-flex align-items-center"
         ...
         <div class="container">
            ...
            <div class="row">
                <div class="col-md-4 text-center mb-4">
                    ...
                    <h4>Unique</h4>
                    <p>Made with fresh, natural ingredients sourced locally from Guimaras</p>
                </div>
                ...
                <div class="col-md-4 text-center mb-4">
                    ...
                    <h4>Affordable</h4>
                    <p>Delivers budget-friendly yet premium treats that bring the authentic flavors of Guimaras closer to everyone.</p>
                </div>
                ...
                <div class="col-md-4 text-center mb-4">
                    ...
                    <p>Only the finest ingredients and highest quality standards</p>
                </div>
            </div>
        </div>
    </section>
