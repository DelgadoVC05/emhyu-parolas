        ...
        <div class="container">
            <div class="row d-flex align-items-center justify-content-between">
                <div class="col-lg-5 mb-4 mb-lg-0">
                    <div class="heritage-content" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-lg-4">
                    <div class="about-img" data-aos="slide-up">
                          <img src="<?php echo get_template_directory_uri(); ?>/assets/images/about-us.png" class="img-fluid" alt="About Image">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="py-5" style="background: white;">
        <div class="container">
            ...
            <div class="row mb-5">
                    ...
                    <div class="story-timeline" data-aos="fade-up" data-aos-delay="200">
                        <div class="timeline-item mb-4 p-4 light-linear" style="border-radius: 15px; border-left: 5px solid var(--primary-green);">
                            <div class="d-flex align-items-center mb-3">
                                <div class="timeline-year" style="background: var(--accent-color); color: white; padding: 8px 15px; border-radius: 20px; font-weight: bold;">2016</div>
                        ...
                        <div class="timeline-item mb-4 p-4 light-linear" style="border-radius: 15px;">
                            <div class="d-flex align-items-center mb-3">
                                <div class="timeline-year" style="background: #FFD700; color: #8B4513; padding: 8px 15px; border-radius: 20px; font-weight: bold;">2017</div>
                        ...
                        <div class="timeline-item mb-4 p-4 light-linear" style="border-radius: 15px;">
                            <div class="d-flex align-items-center mb-3">
                                <div class="timeline-year" style="background: #4682B4; color: white; padding: 8px 15px; border-radius: 20px; font-weight: bold;">2021</div>
                        ...
                        <div class="timeline-item mb-4 p-4 light-linear" style="border-radius: 15px;">
                            <div class="d-flex align-items-center mb-3">
                                <div class="timeline-year" style="background: #FF6B35; color: white; padding: 8px 15px; border-radius: 20px; font-weight: bold;">2024</div>
                ...
                <div class="col-lg-6">
                    <div class="story-visual" data-aos="fade-up" data-aos-delay="200">
                            ...
                            <div class="row">
                                <div class="col-sm-6 mb-3">
                                    <div class="achievement-card p-3 text-center light-linear" style="border-radius: 15px;">
                                        <i class="fas fa-tv fa-2x mb-2" style="color: #FF6B35;"></i>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 mb-4" data-aos="zoom-in" data-aos-delay="300">
                    <div class="vmv-card h-100 p-4 text-center" style="background: white; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                        <div class="vmv-icon mb-3">
                            <i class="fas fa-bullseye fa-3x" style="color: #FF6B35;"></i>
                        </div>
                        <h2>Our Mission</h2>
                ...
                <div class="col-lg-4 mb-4" data-aos="zoom-in" data-aos-delay="400">
                    <div class="vmv-card h-100 p-4 text-center" style="background: white; border-radius: 20px; box-shadow: 0 10px 30px rgba(0,0,0,0.1);">
                        <div class="vmv-icon mb-3">
                            <i class="fas fa-handshake fa-3x" style="color: #FFD700;"></i>
                        </div>
                ...
                <div class="col-lg-6 mb-4"  data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="values-list">
                        <div class="value-item mb-3 p-3 light-linear" style="border-radius: 10px;">
                            <h6 class="fw-bold mb-2"><i class="fas fa-smile me-2" style="color: var(--accent-color);"></i>Customer Satisfaction</h6>
                        ...
                        <div class="value-item mb-3 p-3 light-linear" style="border-radius: 10px;">
                            <h6 class="fw-bold mb-2"><i class="fas fa-shield-alt me-2" style="color: #FFD700;"></i>Business Integrity</h6>
                        ...
                        <div class="value-item mb-3 p-3 light-linear" style="border-radius: 10px;">
                            <h6 class="fw-bold mb-2"><i class="fas fa-eye me-2" style="color: #4682B4;"></i>Business Transparency</h6>
                        ...
                        <div class="value-item mb-3 p-3 light-linear" style="border-radius: 10px;">
                            <h6 class="fw-bold mb-2"><i class="fas fa-users me-2" style="color: #FF6B35;"></i>Community Development</h6>
                ...
                <div class="col-lg-6 mb-4" data-aos="fade-up" data-aos-delay="300">
                    ...
                    <div class="business-list">
                        <div class="business-item mb-3 p-3 light-linear" style="border-radius: 10px;">
                            <h6 class="fw-bold mb-2"><i class="fas fa-star me-2" style="color: var(--accent-color);"></i>Customer Focus</h6>
                        ...
                        <div class="business-item mb-3 p-3 light-linear" style="border-radius: 10px;">
                            <h6 class="fw-bold mb-2"><i class="fas fa-user-graduate me-2" style="color: #FFD700;"></i>People Development</h6>
                            <p class="mb-0 small">We invest in our employees' growth and development, fostering a skilled and motivated workforce.</p>
                        </div>
                        
                        <div class="business-item mb-3 p-3 light-linear" style="border-radius: 10px;">
                            <h6 class="fw-bold mb-2"><i class="fas fa-lightbulb me-2" style="color: #4682B4;"></i>Innovation & Learning</h6>
                            <p class="mb-0 small">Embracing a culture of innovation to continuously improve our products, processes, and services.</p>
                        </div>
                        
                        <div class="business-item mb-3 p-3 light-linear" style="border-radius: 10px;">
                            <h6 class="fw-bold mb-2"><i class="fas fa-chart-line me-2" style="color: #FF6B35;"></i>Community Empowerment and Engagement</h6>
