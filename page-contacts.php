    ...
    <div class="container mb-5">
        <div class="contact__wrapper shadow-lg mt-n9">
            <div class="row no-gutters">
                <!-- Contact Info -->
                <div class="col-lg-5 contact-info__wrapper gradient-brand-color p-5 order-lg-2 fade-info">
                    <h3 class="color--white mb-5">Get in Touch</h3>
                    <ul class="contact-info__list list-style--none position-relative z-index-101">
                        <li class="mb-4 pl-4">
                            <span class="position-absolute"><i class="fas fa-envelope" style="color: var(--accent-color)"></i></span>
                            emhyufoods@gmail.com
                        </li>
                        <li class="mb-4 pl-4">
                            <span class="position-absolute"><i class="fas fa-phone" style="color: var(--accent-color)"></i></span>
                            033 3221247
                        </li>
                        <li class="mb-4 pl-4">
                            <span class="position-absolute"><i class="fas fa-mobile" style="color: var(--accent-color)"></i></span>
                            09605967441 / 09562894178
                        </li>
                        <li class="mb-4 pl-4">
                            <span class="position-absolute"><i class="fas fa-map-marker-alt" style="color: var(--accent-color)"></i></span>
                            San Isidro, Buenavista,<br>Guimaras
                        </li>
                    </ul>
                </div>

                <!-- Contact Form -->
                <div class="col-lg-7 contact-form__wrapper p-5 order-lg-1 fade-form">
                    <form class="contact-form form-validate" id="contact-form" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 mb-3">
                                <div class="form-group">
                                    <label class="required-field mb-2" for="subject">Subject</label>
                            ...
                            <div class="col-12">
                                <button type="submit" class="btn text-light submi-btn w-auto" style="background-color:var(--accent-color);">
